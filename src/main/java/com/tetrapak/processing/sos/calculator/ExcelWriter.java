...
public class ExcelWriter {
     ...
     */
    public static void writeSparePartDataToExcel(Map<Integer, SOSdata> map, String fileName) {
...
//        Write table contents
     ...
     * @param fileName of output file
     */
    public static void writeMaintenanceWorkDataToExcel(Map<Integer, SOSdata> map, String fileName) {
...
//        Write header
        String[] header = {"sosCategory", "cluster", "marketGroup", "market", "finalCustomerNumber", "customerName", "customerGroup", "sosResult"};
